    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            while (counter < features.length()){
                JSONObject oneEarthquake = features.getJSONObject(counter);
                JSONObject oneEarthquakeproperties = oneEarthquake.getJSONObject("properties");
                String earthquakeUrl = oneEarthquakeproperties.getString("url");
                double mag = oneEarthquakeproperties.getDouble("mag");
                DecimalFormat formatter = new DecimalFormat("0.00");
                mag = Double.parseDouble(formatter.format(mag));
                String Location = oneEarthquakeproperties.getString("place");
                ...
                long mDate  = oneEarthquakeproperties.getLong("time");
                ...
                Earthquake newEarthquake = new Earthquake(mag,position,place,date,time,earthquakeUrl);
